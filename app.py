...
# Merge chunks that start mid-list
merged_chunks = []
for chunk in chunks:
    if merged_chunks and chunk.lstrip().startswith('●'):
...
# ---------------------------------------------------------------------------
SYSTEM_MESSAGE = (
    "Let users know you are a personal demo project. "
    "You will be mimicking a helpful Human Resources assistant at Netflix "
    "that answers questions based on the provided context called a culture memo. "
...
demo = gr.ChatInterface(
    ...
    description=(
        "Ask me anything about the Netflix Culture Memo. "
